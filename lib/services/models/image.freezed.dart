...
abstract class $ImageModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String path, bool completed});
}
...
class _$ImageModelImpl with DiagnosticableTreeMixin implements _ImageModel {
  _$ImageModelImpl(
      {required this.name, required this.path, this.completed = false});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ImageModel(name: $name, path: $path, completed: $completed)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, path, completed);
...
abstract class _ImageModel implements ImageModel {
  factory _ImageModel(
      ...
      final bool completed}) = _$ImageModelImpl;
