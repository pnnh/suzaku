...
import 'package:suzaku/models/note.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return MouseRegion(
      child: Container(
        ...
        color: ref.watch(_activeItem) == this.noteModel.pk
            ? Color(0xFFF2F2F2)
            : Colors.transparent,
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            Text(
              "我的建议是，随着新的更新，Mac上的应用程序策略发生了一些变化。在此之前，开发人员对应用程序的签名不是那么必要，现在是。",
      ...
      onEnter: (event) {
        ref.read(_activeItem.notifier).update((state) => this.noteModel.pk);
      },
      onExit: (event) {
